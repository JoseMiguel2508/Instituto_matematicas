...
return new class extends Migration
{
    ...
    {
        // 1. Procedimiento Crear Estudiante
        DB::unprepared("
            ...
            BEGIN
                ...
                -- Insertar Estudiante
                INSERT INTO estudiante (id_estudiante, codigo_estudiante, fecha_ingreso, estado)
                VALUES (v_id_persona, p_codigo_estudiante, CURRENT_DATE(), 'Activo');
        ...
        // 2. Procedimiento Actualizar Estudiante
        DB::unprepared("
            ...
            BEGIN
                ...
                UPDATE estudiante SET estado = p_estado WHERE id_estudiante = p_id_estudiante;
                
                COMMIT;
            END
        ");

        // 3. Procedimiento Eliminar Estudiante
        DB::unprepared("
            ...
            BEGIN
                ...
                START TRANSACTION;
                -- Gracias al ON DELETE CASCADE en MySQL, eliminar al estudiante debería eliminar sus deudas y otros registros vinculados.
                -- Opcionalmente, se elimina a la persona completa
                DELETE FROM estudiante WHERE id_estudiante = p_id_estudiante;
                DELETE FROM persona WHERE id_persona = p_id_estudiante;
    ...
    public function down(): void
    {
        ...
        DB::unprepared("DROP PROCEDURE IF EXISTS sp_eliminar_estudiante");
    }
};
